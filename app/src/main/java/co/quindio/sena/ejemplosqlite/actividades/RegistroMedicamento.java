...
public class RegistroMedicamento extends AppCompatActivity {
    ...
    EditText razaMascota,nombreMascota,creditosMascota;
    Spinner comboDuenio;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        creditosMascota = (EditText) findViewById(R.id.campoCreditos);
    ...
    private void registrarMascota() {
         ...
         values.put(Utilidades.CAMPO_CREDITOS_MASCOTA,creditosMascota.getText().toString());
